...
from plone.app.testing.interfaces import (TEST_USER_ID, TEST_USER_PASSWORD, TEST_USER_NAME)
...
class CustomView(BrowserView):
    """
    A custom view. It raises an `Unauthorized` when one tries to access the `macros` attribute,
